...
public class TelaCadastraTransacoes extends JFrame {
	...
	public TelaCadastraTransacoes() {
		...
		JTextPane jtpCarteira = new JTextPane();
		jtpCarteira.setText("");
		jtpCarteira.setBounds(148, 73, 566, 199);
		contentPane.add(jtpCarteira);
		
		JLabel lblResumoDaCarteira = new JLabel("Resumo da Carteira");
